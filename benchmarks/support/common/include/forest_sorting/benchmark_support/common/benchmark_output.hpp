#ifndef FOREST_SORTING_BENCHMARK_SUPPORT_COMMON_BENCHMARK_OUTPUT_HPP
#define FOREST_SORTING_BENCHMARK_SUPPORT_COMMON_BENCHMARK_OUTPUT_HPP
...
inline void printJsonScalar(std::ostream &output,
    ...
    if (std::holds_alternative<std::monostate>(value)) {
        output << "null";
    } else if (const auto *text = std::get_if<std::string_view>(&value)) {
...
#endif // FOREST_SORTING_BENCHMARK_SUPPORT_COMMON_BENCHMARK_OUTPUT_HPP
