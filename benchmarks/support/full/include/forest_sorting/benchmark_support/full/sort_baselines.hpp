#ifndef FOREST_SORTING_BENCHMARK_SUPPORT_FULL_SORT_BASELINES_HPP
#define FOREST_SORTING_BENCHMARK_SUPPORT_FULL_SORT_BASELINES_HPP
    ...
    auto sortBuckets = [&](std::vector<std::vector<std::size_t>> &buckets,
        ...
        for (auto &bucket : buckets) {
            detail::sortIndexRangeByIdMsdChunks<
                dense_bucket_id_msd_radix_chunk_bytes, FullClearIdCountPolicy>(
...
#endif // FOREST_SORTING_BENCHMARK_SUPPORT_FULL_SORT_BASELINES_HPP
